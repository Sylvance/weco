...
template.innerHTML = `
    <style>
        ...
        :host(ruby-text-tag) {
            /* if my shadow root is ruby-text-tag */
        }
    ...
    <rt class="ruby-text-tag" part="ruby-text-tag"></rt>
`;

class RubyTextTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('ruby-text-tag', RubyTextTag);

// <ruby-text-tag id='some id'>
// </ruby-text-tag>
