...
template.innerHTML = `
    <style>
        ...
        :host(table-row-tag) {
            /* if my shadow root is table-row-tag */
        }
    ...
    <tr class="table-row-tag" part="table-row-tag"></tr>
`;

class TableRowTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('table-row-tag', TableRowTag);

// <table-row-tag id='some id'>
// </table-row-tag>
