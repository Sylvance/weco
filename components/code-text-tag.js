...
template.innerHTML = `
    <style>
        ...
        :host(code-text-tag) {
            /* if my shadow root is code-text-tag */
        }
    ...
    <code class="code-text-tag" part="code-text-tag"></code>
`;

class CodeTextTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('code-text-tag', CodeTextTag);

// <code-text-tag id='some id'>
// </code-text-tag>
