...
template.innerHTML = `
    <style>
        ...
        :host(video-content-tag) {
            /* if my shadow root is video-content-tag */
        }
    ...
    <video class="video-content-tag" part="video-content-tag"></video>
`;

class VideoContentTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('video-content-tag', VideoContentTag);

// <video-content-tag id='some id'>
// </video-content-tag>
