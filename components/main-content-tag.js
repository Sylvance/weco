...
template.innerHTML = `
    <style>
        ...
        :host(main-content-tag) {
            /* if my shadow root is main-content-tag */
        }
    ...
    <main class="main-content-tag" part="main-content-tag"></main>
`;

class MainContentTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('main-content-tag', MainContentTag);

// <main-content-tag id='some id'>
// </main-content-tag>
