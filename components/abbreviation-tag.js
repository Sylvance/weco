...
template.innerHTML = `
    <style>
        ...
        :host(abbreviation-tag) {
            /* if my shadow root is abbreviation-tag */
        }
    ...
    <abbr class="abbreviation-tag" part="abbreviation-tag"></abbr>
`;

class AbbreviationTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('abbreviation-tag', AbbreviationTag);

// <abbreviation-tag id='some id'>
// </abbreviation-tag>
