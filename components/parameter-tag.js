...
template.innerHTML = `
    <style>
        ...
        :host(parameter-tag) {
            /* if my shadow root is parameter-tag */
        }
    ...
    <param class="parameter-tag" part="parameter-tag"></param>
`;

class ParameterTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('parameter-tag', ParameterTag);

// <parameter-tag id='some id'>
// </parameter-tag>
