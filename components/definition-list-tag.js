...
template.innerHTML = `
    <style>
        ...
        :host(definition-list-tag) {
            /* if my shadow root is definition-list-tag */
        }
    ...
    <dl class="definition-list-tag" part="definition-list-tag"></dl>
`;

class DefinitionListTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('definition-list-tag', DefinitionListTag);

// <definition-list-tag id='some id'>
// </definition-list-tag>
