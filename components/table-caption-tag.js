...
template.innerHTML = `
    <style>
        ...
        :host(table-caption-tag) {
            /* if my shadow root is table-caption-tag */
        }
    ...
    <caption class="table-caption-tag" part="table-caption-tag"></caption>
`;

class TableCaptionTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('table-caption-tag', TableCaptionTag);

// <table-caption-tag id='some id'>
// </table-caption-tag>
