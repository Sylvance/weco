...
template.innerHTML = `
    <style>
        ...
        :host(document-body-tag) {
            /* if my shadow root is document-body-tag */
        }
    ...
    <body class="document-body-tag" part="document-body-tag"></body>
`;

class DocumentBodyTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('document-body-tag', DocumentBodyTag);

// <document-body-tag id='some id'>
// </document-body-tag>
