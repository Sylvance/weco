...
template.innerHTML = `
    <style>
        ...
        :host(document-head-tag) {
            /* if my shadow root is document-head-tag */
        }
    ...
    <head class="document-head-tag" part="document-head-tag"></head>
`;

class DocumentHeadTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('document-head-tag', DocumentHeadTag);

// <document-head-tag id='some id'>
// </document-head-tag>
