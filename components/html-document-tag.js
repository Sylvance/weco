...
template.innerHTML = `
    <style>
        ...
        :host(html-document-tag) {
            /* if my shadow root is html-document-tag */
        }
    ...
    <html class="html-document-tag" part="html-document-tag"></html>
`;

class HtmlDocumentTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('html-document-tag', HtmlDocumentTag);

// <html-document-tag id='some id'>
// </html-document-tag>
