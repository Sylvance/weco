...
template.innerHTML = `
    <style>
        ...
        :host(underlined-text-tag) {
            /* if my shadow root is underlined-text-tag */
        }
    ...
    <u class="underlined-text-tag" part="underlined-text-tag"></u>
`;

class UnderlinedTextTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('underlined-text-tag', UnderlinedTextTag);

// <underlined-text-tag id='some id'>
// </underlined-text-tag>
