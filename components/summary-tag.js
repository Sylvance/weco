...
template.innerHTML = `
    <style>
        ...
        :host(summary-tag) {
            /* if my shadow root is summary-tag */
        }
    ...
    <summary class="summary-tag" part="summary-tag"></summary>
`;

class SummaryTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('summary-tag', SummaryTag);

// <summary-tag id='some id'>
// </summary-tag>
