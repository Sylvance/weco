...
template.innerHTML = `
    <style>
        ...
        :host(input-control-tag) {
            /* if my shadow root is input-control-tag */
        }
    ...
    <input class="input-control-tag" part="input-control-tag"></input>
`;

class InputControlTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('input-control-tag', InputControlTag);

// <input-control-tag id='some id'>
// </input-control-tag>
