...
template.innerHTML = `
    <style>
        ...
        :host(variable-tag) {
            /* if my shadow root is variable-tag */
        }
    ...
    <var class="variable-tag" part="variable-tag"></var>
`;

class VariableTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('variable-tag', VariableTag);

// <variable-tag id='some id'>
// </variable-tag>
