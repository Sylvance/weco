...
template.innerHTML = `
    <style>
        ...
        :host(small-text-tag) {
            /* if my shadow root is small-text-tag */
        }
    ...
    <small class="small-text-tag" part="small-text-tag"></small>
`;

class SmallTextTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('small-text-tag', SmallTextTag);

// <small-text-tag id='some id'>
// </small-text-tag>
