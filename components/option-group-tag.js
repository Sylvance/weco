...
template.innerHTML = `
    <style>
        ...
        :host(option-group-tag) {
            /* if my shadow root is option-group-tag */
        }
    ...
    <optgroup class="option-group-tag" part="option-group-tag"></optgroup>
`;

class OptionGroupTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('option-group-tag', OptionGroupTag);

// <option-group-tag id='some id'>
// </option-group-tag>
