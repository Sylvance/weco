...
template.innerHTML = `
    <style>
        ...
        :host(citation-tag) {
            /* if my shadow root is citation-tag */
        }
    ...
    <cite class="citation-tag" part="citation-tag"></cite>
`;

class CitationTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('citation-tag', CitationTag);

// <citation-tag id='some id'>
// </citation-tag>
