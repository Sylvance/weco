...
template.innerHTML = `
    <style>
        ...
        :host(strong-text-tag) {
            /* if my shadow root is strong-text-tag */
        }
    ...
    <strong class="strong-text-tag" part="strong-text-tag"></strong>
`;

class StrongTextTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('strong-text-tag', StrongTextTag);

// <strong-text-tag id='some id'>
// </strong-text-tag>
