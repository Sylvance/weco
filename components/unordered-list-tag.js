...
template.innerHTML = `
    <style>
        ...
        :host(unordered-list-tag) {
            /* if my shadow root is unordered-list-tag */
        }
    ...
    <ul class="unordered-list-tag" part="unordered-list-tag"></ul>
`;

class UnorderedListTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('unordered-list-tag', UnorderedListTag);

// <unordered-list-tag id='some id'>
// </unordered-list-tag>
