...
template.innerHTML = `
    <style>
        ...
        :host(metadata-tag) {
            /* if my shadow root is metadata-tag */
        }
    ...
    <meta class="metadata-tag" part="metadata-tag"></meta>
`;

class MetadataTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('metadata-tag', MetadataTag);

// <metadata-tag id='some id'>
// </metadata-tag>
