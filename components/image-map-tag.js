...
template.innerHTML = `
    <style>
        ...
        :host(image-map-tag) {
            /* if my shadow root is image-map-tag */
        }
    ...
    <map class="image-map-tag" part="image-map-tag"></map>
`;

class ImageMapTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('image-map-tag', ImageMapTag);

// <image-map-tag id='some id'>
// </image-map-tag>
