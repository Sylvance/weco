...
template.innerHTML = `
    <style>
        ...
        :host(data-list-tag) {
            /* if my shadow root is data-list-tag */
        }
    ...
    <datalist class="data-list-tag" part="data-list-tag"></datalist>
`;

class DataListTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('data-list-tag', DataListTag);

// <data-list-tag id='some id'>
// </data-list-tag>
