...
template.innerHTML = `
    <style>
        ...
        :host(container-tag) {
            /* if my shadow root is container-tag */
        }
    ...
    <div class="container-tag" part="container-tag"></div>
`;
...
customElements.define('container-tag', ContainerTag);

// <container-tag id='some id'>
// </container-tag>
