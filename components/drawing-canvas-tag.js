...
template.innerHTML = `
    <style>
        ...
        :host(drawing-canvas-tag) {
            /* if my shadow root is drawing-canvas-tag */
        }
    ...
    <canvas class="drawing-canvas-tag" part="drawing-canvas-tag"></canvas>
`;

class DrawingCanvasTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('drawing-canvas-tag', DrawingCanvasTag);

// <drawing-canvas-tag id='some id'>
// </drawing-canvas-tag>
