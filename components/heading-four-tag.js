...
template.innerHTML = `
    <style>
        ...
        :host(heading-four-tag) {
            /* if my shadow root is heading-four-tag */
        }
    ...
    <h4 class="heading-four-tag" part="heading-four-tag"></h4>
`;

class HeadingFourTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('heading-four-tag', HeadingFourTag);

// <heading-four-tag id='some id'>
// </heading-four-tag>
