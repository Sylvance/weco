...
template.innerHTML = `
    <style>
        ...
        :host(address-tag) {
            /* if my shadow root is address-tag */
        }
    ...
    <address class="address-tag" part="address-tag"></address>
`;

class AddressTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('address-tag', AddressTag);

// <address-tag id='some id'>
// </address-tag>
