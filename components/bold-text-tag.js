...
template.innerHTML = `
    <style>
        ...
        :host(bold-text-tag) {
            /* if my shadow root is bold-text-tag */
        }
    ...
    <b class="bold-text-tag" part="bold-text-tag"></b>
`;

class BoldTextTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('bold-text-tag', BoldTextTag);

// <bold-text-tag id='some id'>
// </bold-text-tag>
