...
template.innerHTML = `
    <style>
        ...
        :host(heading-one-tag) {
            /* if my shadow root is heading-one-tag */
        }
    ...
    <h1 class="heading-one-tag" part="heading-one-tag"></h1>
`;

class HeadingOneTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('heading-one-tag', HeadingOneTag);

// <heading-one-tag id='some id'>
// </heading-one-tag>
