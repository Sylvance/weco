...
template.innerHTML = `
    <style>
        ...
        :host(text-area-tag) {
            /* if my shadow root is text-area-tag */
        }
    ...
    <textarea class="text-area-tag" part="text-area-tag"></textarea>
`;

class TextAreaTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('text-area-tag', TextAreaTag);

// <text-area-tag id='some id'>
// </text-area-tag>
