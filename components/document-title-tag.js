...
template.innerHTML = `
    <style>
        ...
        :host(document-title-tag) {
            /* if my shadow root is document-title-tag */
        }
    ...
    <title class="document-title-tag" part="document-title-tag"></title>
`;

class DocumentTitleTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('document-title-tag', DocumentTitleTag);

// <document-title-tag id='some id'>
// </document-title-tag>
