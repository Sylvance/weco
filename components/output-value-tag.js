...
template.innerHTML = `
    <style>
        ...
        :host(output-value-tag) {
            /* if my shadow root is output-value-tag */
        }
    ...
    <output class="output-value-tag" part="output-value-tag"></output>
`;

class OutputValueTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('output-value-tag', OutputValueTag);

// <output-value-tag id='some id'>
// </output-value-tag>
