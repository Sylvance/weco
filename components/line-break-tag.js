...
template.innerHTML = `
    <style>
        ...
        :host(line-break-tag) {
            /* if my shadow root is line-break-tag */
        }
    ...
    <br class="line-break-tag" part="line-break-tag"></br>
`;

class LineBreakTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('line-break-tag', LineBreakTag);

// <line-break-tag id='some id'>
// </line-break-tag>
