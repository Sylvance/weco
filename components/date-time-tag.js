...
template.innerHTML = `
    <style>
        ...
        :host(date-time-tag) {
            /* if my shadow root is date-time-tag */
        }
    ...
    <time class="date-time-tag" part="date-time-tag"></time>
`;
...
customElements.define('date-time-tag', DateTimeTag);

// <date-time-tag id='some id'>
// </date-time-tag>
