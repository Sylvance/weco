...
template.innerHTML = `
    <style>
        ...
        :host(paragraph-tag) {
            /* if my shadow root is paragraph-tag */
        }
    ...
    <p class="paragraph-tag" part="paragraph-tag"></p>
`;

class ParagraphTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('paragraph-tag', ParagraphTag);

// <paragraph-tag id='some id'>
// </paragraph-tag>
