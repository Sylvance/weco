...
template.innerHTML = `
    <style>
        ...
        :host(heading-three-tag) {
            /* if my shadow root is heading-three-tag */
        }
    ...
    <h3 class="heading-three-tag" part="heading-three-tag"></h3>
`;

class HeadingThreeTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('heading-three-tag', HeadingThreeTag);

// <heading-three-tag id='some id'>
// </heading-three-tag>
