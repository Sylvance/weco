...
template.innerHTML = `
    <style>
        ...
        :host(template-tag) {
            /* if my shadow root is template-tag */
        }
    ...
    <template class="template-tag" part="template-tag"></template>
`;
...
customElements.define('template-tag', TemplateTag);

// <template-tag id='some id'>
// </template-tag>
