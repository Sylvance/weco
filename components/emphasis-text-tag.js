...
template.innerHTML = `
    <style>
        ...
        :host(emphasis-text-tag) {
            /* if my shadow root is emphasis-text-tag */
        }
    ...
    <em class="emphasis-text-tag" part="emphasis-text-tag"></em>
`;

class EmphasisTextTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('emphasis-text-tag', EmphasisTextTag);

// <emphasis-text-tag id='some id'>
// </emphasis-text-tag>
