...
template.innerHTML = `
    <style>
        ...
        :host(navigation-links-tag) {
            /* if my shadow root is navigation-links-tag */
        }
    ...
    <nav class="navigation-links-tag" part="navigation-links-tag"></nav>
`;

class NavigationLinksTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('navigation-links-tag', NavigationLinksTag);

// <navigation-links-tag id='some id'>
// </navigation-links-tag>
