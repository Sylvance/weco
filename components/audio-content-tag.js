...
template.innerHTML = `
    <style>
        ...
        :host(audio-content-tag) {
            /* if my shadow root is audio-content-tag */
        }
    ...
    <audio class="audio-content-tag" part="audio-content-tag"></audio>
`;

class AudioContentTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('audio-content-tag', AudioContentTag);

// <audio-content-tag id='some id'>
// </audio-content-tag>
