...
template.innerHTML = `
    <style>
        ...
        :host(list-item-tag) {
            /* if my shadow root is list-item-tag */
        }
    ...
    <li class="list-item-tag" part="list-item-tag"></li>
`;

class ListItemTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('list-item-tag', ListItemTag);

// <list-item-tag id='some id'>
// </list-item-tag>
