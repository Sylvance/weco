...
template.innerHTML = `
    <style>
        ...
        :host(sample-output-tag) {
            /* if my shadow root is sample-output-tag */
        }
    ...
    <samp class="sample-output-tag" part="sample-output-tag"></samp>
`;

class SampleOutputTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('sample-output-tag', SampleOutputTag);

// <sample-output-tag id='some id'>
// </sample-output-tag>
