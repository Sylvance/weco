...
template.innerHTML = `
    <style>
        ...
        :host(definition-term-tag) {
            /* if my shadow root is definition-term-tag */
        }
    ...
    <dt class="definition-term-tag" part="definition-term-tag"></dt>
`;

class DefinitionTermTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('definition-term-tag', DefinitionTermTag);

// <definition-term-tag id='some id'>
// </definition-term-tag>
