...
template.innerHTML = `
    <style>
        ...
        :host(heading-two-tag) {
            /* if my shadow root is heading-two-tag */
        }
    ...
    <h2 class="heading-two-tag" part="heading-two-tag"></h2>
`;

class HeadingTwoTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('heading-two-tag', HeadingTwoTag);

// <heading-two-tag id='some id'>
// </heading-two-tag>
