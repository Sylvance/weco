...
template.innerHTML = `
    <style>
        ...
        :host(heading-five-tag) {
            /* if my shadow root is heading-five-tag */
        }
    ...
    <h5 class="heading-five-tag" part="heading-five-tag"></h5>
`;

class HeadingFiveTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('heading-five-tag', HeadingFiveTag);

// <heading-five-tag id='some id'>
// </heading-five-tag>
