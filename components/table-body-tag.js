...
template.innerHTML = `
    <style>
        ...
        :host(table-body-tag) {
            /* if my shadow root is table-body-tag */
        }
    ...
    <tbody class="table-body-tag" part="table-body-tag"></tbody>
`;

class TableBodyTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('table-body-tag', TableBodyTag);

// <table-body-tag id='some id'>
// </table-body-tag>
