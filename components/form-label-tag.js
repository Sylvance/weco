...
template.innerHTML = `
    <style>
        ...
        :host(form-label-tag) {
            /* if my shadow root is form-label-tag */
        }
    ...
    <label class="form-label-tag" part="form-label-tag"></label>
`;

class FormLabelTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('form-label-tag', FormLabelTag);

// <form-label-tag id='some id'>
// </form-label-tag>
