...
template.innerHTML = `
    <style>
        ...
        :host(short-quotation-tag) {
            /* if my shadow root is short-quotation-tag */
        }
    ...
    <q class="short-quotation-tag" part="short-quotation-tag"></q>
`;

class ShortQuotationTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('short-quotation-tag', ShortQuotationTag);

// <short-quotation-tag id='some id'>
// </short-quotation-tag>
