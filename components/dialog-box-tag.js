...
template.innerHTML = `
    <style>
        ...
        :host(dialog-box-tag) {
            /* if my shadow root is dialog-box-tag */
        }
    ...
    <dialog class="dialog-box-tag" part="dialog-box-tag"></dialog>
`;

class DialogBoxTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('dialog-box-tag', DialogBoxTag);

// <dialog-box-tag id='some id'>
// </dialog-box-tag>
