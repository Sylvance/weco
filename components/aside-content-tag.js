...
template.innerHTML = `
    <style>
        ...
        :host(aside-content-tag) {
            /* if my shadow root is aside-content-tag */
        }
    ...
    <aside class="aside-content-tag" part="aside-content-tag"></aside>
`;

class AsideContentTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('aside-content-tag', AsideContentTag);

// <aside-content-tag id='some id'>
// </aside-content-tag>
