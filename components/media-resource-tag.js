...
template.innerHTML = `
    <style>
        ...
        :host(media-resource-tag) {
            /* if my shadow root is media-resource-tag */
        }
    ...
    <source class="media-resource-tag" part="media-resource-tag"></source>
`;

class MediaResourceTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('media-resource-tag', MediaResourceTag);

// <media-resource-tag id='some id'>
// </media-resource-tag>
