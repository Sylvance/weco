...
template.innerHTML = `
    <style>
        ...
        :host(italic-text-tag) {
            /* if my shadow root is italic-text-tag */
        }
    ...
    <i class="italic-text-tag" part="italic-text-tag"></i>
`;

class ItalicTextTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('italic-text-tag', ItalicTextTag);

// <italic-text-tag id='some id'>
// </italic-text-tag>
