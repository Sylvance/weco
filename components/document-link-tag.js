...
template.innerHTML = `
    <style>
        ...
        :host(document-link-tag) {
            /* if my shadow root is document-link-tag */
        }
    ...
    <link class="document-link-tag" part="document-link-tag"></link>
`;

class DocumentLinkTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('document-link-tag', DocumentLinkTag);

// <document-link-tag id='some id'>
// </document-link-tag>
