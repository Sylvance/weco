...
template.innerHTML = `
    <style>
        ...
        :host(ordered-list-tag) {
            /* if my shadow root is ordered-list-tag */
        }
    ...
    <ol class="ordered-list-tag" part="ordered-list-tag"></ol>
`;

class OrderedListTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('ordered-list-tag', OrderedListTag);

// <ordered-list-tag id='some id'>
// </ordered-list-tag>
