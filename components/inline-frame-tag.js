...
template.innerHTML = `
    <style>
        ...
        :host(inline-frame-tag) {
            /* if my shadow root is inline-frame-tag */
        }
    ...
    <iframe class="inline-frame-tag" part="inline-frame-tag"></iframe>
`;

class InlineFrameTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('inline-frame-tag', InlineFrameTag);

// <inline-frame-tag id='some id'>
// </inline-frame-tag>
