...
template.innerHTML = `
    <style>
        ...
        :host(deleted-text-tag) {
            /* if my shadow root is deleted-text-tag */
        }
    ...
    <del class="deleted-text-tag" part="deleted-text-tag"></del>
`;

class DeletedTextTag extends HTMLElement {
    constructor() {
        super();
...
customElements.define('deleted-text-tag', DeletedTextTag);

// <deleted-text-tag id='some id'>
// </deleted-text-tag>
